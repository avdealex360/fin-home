...
- **Все операции** — второй пункт нижнего меню (или «Ещё» → «Все операции»): фильтр по типу, **мультивыбор категорий**, фильтр по корзине и участнику, **быстрые периоды** (сегодня/вчера/неделя/месяц/год) или свой диапазон дат — по умолчанию текущий месяц. Список группируется по месяцам и дням с суммой расходов у каждого заголовка; сортировка, страницы, правка и удаление с отменой.
