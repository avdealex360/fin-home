...
«Ещё» → «Кошелёк USDC» (раздел доступен всем участникам): адрес, ключ Etherscan, порог. Дальше баланс виден по тапу на большое число на Главной, а бот раз в месяц напишет, когда баланс превысит порог. Подробно: [usdc-wallet-setup.md](usdc-wallet-setup.md).
