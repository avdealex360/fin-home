...
- **распределять доход** по корзинам (нужды / желания / сбережения) по категориям и копилкам;
...
Наглядные сценарии: как устроены деньги, распределение дохода, копилки, калькулятор вклада, план, закрытие месяца, все операции, категории, устройства.
...
| `IncomeAllocation` | Связь дохода с категорией (`category_id`) или копилкой (`fund_id`) на уровне (`allocation_level`) |
